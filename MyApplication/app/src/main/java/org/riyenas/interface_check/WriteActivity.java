...
public class WriteActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextContents = (EditText)findViewById(R.id.editText_main_address);
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String address = mEditTextContents.getText().toString();
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://interface518.dothome.co.kr/inter/board.php";
            String postParameters = "&name=" + name + "&contents=" + contents;
